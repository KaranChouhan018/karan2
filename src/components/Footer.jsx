...
const Footer = ( ) => {
  ...
  return (
    <footer className=" py-16 ">
      <div className="container1 max-w-[95%] mx-auto px-6">
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="https://linkedin.com" className="font-light">LinkedIn</Link></li>
              <li><Link href="https://youtube.com" className="hover:text-stone-900">YouTube</Link></li>
              <li><Link href="https://instagram.com" className="hover:text-stone-900">Instagram</Link></li>
              <li><Link href="https://bento.me" className="hover:text-stone-900">Bento</Link></li>
              <li><Link href="https://github.com" className="hover:text-stone-900">Github</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-[20%] mb-[10%] w-full flex flex-row gap-[10px] md:flex-row justify-between items-end md:items-center">
          <div>
            <p className="text-xl md:text- 5xl font-bold">© 2025 </p>
            <p className="text-2xl md:text- 5xl font-bold">Karan Chouhan </p>
            <p className="text-2xl md:text- 5xl font-bold">All rights reserved.</p>
          </div>
