...
//       <div className="max-w-[95%] mx-auto mt-[6%] grid grid-cols-2 gap-8">
//         {/* Left Section - Testimonial */}
//         <div className="flex flex-col items-start ">
//           <h1 className="text-4xl font-bold text-black leading-tight">
//             "Huy is phenomenal. <br />
//             An absolute pleasure <br />
//             to work with!"
//           </h1>
//           <p className="mt-6 text-gray-700">
//             <span className="font-medium text-black">Pieter Pattyn</span> <br />
//             Founder&apos;s Associate @Volup
//           </p>
//           {/* Tags */}
//           <div className="mt-4 flex gap-2">
//             {["WEB DESIGN", "WEB DEVELOPMENT", "SEO"].map((tag, index) => (
//               <span
//                 key={index}
...
//             alt="Smiling man with black t-shirt against a backdrop with a repeating 'V' pattern"
//             width={1080}
//             height={1980}
...
//       {/* Bottom Navigation */}
//       <div className="absolute bottom-[11%] flex items-center justify-between w-[50%] px-16 text-gray-700">
//         <div className="text-sm">
//           1 <span className="mx-2">——</span> 2
//         </div>
//         <div className="flex gap-4">
//           <button className="px-4 py-2 bg-black text-white rounded-3xl">PREV</button>
//           <button className="px-4 py-2 bg-black text-white rounded-3xl">NEXT</button>
//         </div>
//       </div>
//     </div>
//       <div className="flex flex-row justify-between  text-[#7A7875]  p-6 rounded-lg w-full max-w-md mx-auto block  md:hidden">
...
//           <span key={tag} className="px-3 py-1 border border-[#7A7875]  text-xs font-semibold rounded-xl">
//             {tag}
//           </span>
//         ))}
//       </div>
...
//     </div>
//       <div className="flex flex-row justify-between gap-8 text-[#7A7875]  p-6 rounded-lg w-full max-w-md mx-auto  mb-20 md:hidden">
...
//       <div className="flex space-x-2 mt-4">
//         {["WEB DESIGN", "WEB DEVELOPMENT", "SEO"].map((tag) => (
//           <span key={tag} className="px-3 py-1 text-xs border border-[#7A7875] font-semibold rounded-xl">
//             {tag}
//           </span>
//         ))}
//       </div>
...
const testimonials = [
  {
    ...
    imageSrc: "/images/floating_1.jpg",
    imageAlt: "Smiling man with black t-shirt against a backdrop with a repeating 'V' pattern"
  },
  {
    id: 2,
    quote: "\"Working with Huy was a game-changing <br />  experience for our project.\"",
    name: "Sarah Johnson",
...
export default function Testimonial() {
  ...
  return (
    <section className="relative w-full">
      ...
      <div className="min-h-screen flex items-start justify-between hidden lg:block ">
        <div className="max-w-[95%] mx-auto mt-[6%] grid md:grid-cols-1   lg:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col order-2 items-start">
            ...
            <p className="mt-6 text-gray-700">
              <span className="font-medium text-black">{current.name}</span> <br />
          ...
          {/* Right Section - Image */}
          <div className="relative w-full h-[60vh] lg:h-[80vh] md:order-1 lg:order-2 rounded-md overflow-hidden">
            <Image
        ...
        {/* Bottom Navigation */}
        <div className="absolute bottom-[11%] flex flex-row items-center justify-between w-[50%] px-16 text-gray-700 hidden md:hidden lg:block">
          <div className="text-sm">
            {currentTestimonial + 1} <span className="mx-2">——</span> {testimonials.length}
          </div>
          <div className="flex gap-4">
            <button 
              onClick={handlePrev} 
