  ...
  return (
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2   text-center w-full leading-tight">
      ...
      <h1  className="md:pr-[15%]  text-4xl  text-[#161614]  md:text-5xl lg:text-6xl font-black font-neue">HI THERE, I&apos;M</h1> <br/>
          <h1 className="md:pl-[15%] text-4xl text-[#161614] md:text-5xl lg:text-6xl font-black font-neue">YOUR NAME.</h1> <br/>
      ...
      <div className='overflow-hidden mt-[10%] w-[95%] mx-auto text-center md:mt-[8%] lg:mt-[5%]' ref={freeRef}>
        ...
        <h1 className='text-lg text-[#6A645C] md:text-2xl'>Based in Your Location </h1>
      </div>
    </div>
  );
}